...
class UDPMessageSender implements MessageSender {
	...
	public void sendData(URI destination, String data) {
		...
		// destination.toString() + ": " + data); //DEBUG, TODO: REMOVE
	}

	/**
	 * Can return null if local ip address is unknown Will only return a single
	 * IP address even if we are bound to multiple
	 * 
	 * @return
	 */
	@Override
